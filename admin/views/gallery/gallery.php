                                    ...
                                    <div class="card" id="mydiv">
                                        ...
                                        <div>
                                            <div id="">
                                                    ...
                                                    <button style="margin:20px" type="button" id="addMe" class="c_btn">Ajouter une photo</button>       
                                                        ...
                                                        <table id="dynamic" class="table table-hover table-striped">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                ?>
                                                                    <tr>
                                                                        <td>
                                                                            <?php echo $photo->getId(); ?>
                                                                        </td>
                                                                        <td>
                                                                            <a href="../images/gallery/<?php echo $photo->getFilename(); ?>"><?php echo $photo->getFilename(); ?></a>
                                                                        </td>
    ...
    <script>
            ...
            $(function() {
                $('span.deleteMe').click(function(e) {
                    $.get("views/gallery/gallery-delete.php?id=" + $(this).attr('name'), function (data) {
                        $("#testing").html(data);
                    });                    
                   showHiddener();
                });
                $('#addMe').click(function(e) {
                    $.get("views/gallery/gallery-add.php", function (data) {
                        $("#testing").html(data);
                    });                    
                   showHiddener();
                });
