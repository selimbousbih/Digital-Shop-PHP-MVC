<link rel="stylesheet" type="text/css" href="assets/css/members_login.css" />
    ...
    <a href="index.php"><img class="logor" src="logo.png" style="width: 20%;"></a>
			<div class="wrapper">
                <div class="content">
                    <div id="form_wrapper" class="form_wrapper">
					<?php if(isset($_GET['error'])){
						echo '<p style="text-align: center; font-size: 18px;">Vérifier votre login</p>';
					} ?>
					<!-- LOGIN FORM STARTS -->
						<form class="login active" method="post" action="includes/process_login.php">
                            <h1>SE CONNECTER</h1>
                        ...
                        <form class="register" method="post" action="includes/register.php">
                            ...
                            <input type="password" name="passwordc" placeholder="Confirmer le mot de passe">
                            <div>
